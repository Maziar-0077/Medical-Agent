...
# Use a multilingual model that handles Persian well
MULTILINGUAL_MODEL = "llama-3.3-70b-versatile"  # Supports Persian, English, etc.
EMBEDDING_MODEL = "llama-3.1-8b-instant"        # For embedding fallback
